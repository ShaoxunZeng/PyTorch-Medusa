...
__all__ = [
    ...
    "memory_shutdown_free",
    "memory_turnon_free",
    "memory_stop_trace_malloc_free"
]
...
def memory_shutdown_free():
    torch._C._cuda_shutdownFree()
    
def memory_stop_trace_malloc_free():
    torch._C._cuda_stopTraceMallocFree()
    
def memory_turnon_free():
    torch._C._cuda_turnonFree()
