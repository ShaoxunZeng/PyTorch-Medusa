...
PyObject* THCPModule_shutdownFree(PyObject* _unused, PyObject* noargs) {
  HANDLE_TH_ERRORS
  c10::cuda::CUDACachingAllocator::shutdownFree();
  END_HANDLE_TH_ERRORS
  Py_RETURN_NONE;
}

PyObject* THCPModule_stopTraceMallocFree(PyObject* _unused, PyObject* noargs) {
  HANDLE_TH_ERRORS
  c10::cuda::CUDACachingAllocator::stopTraceMallocFree();
  END_HANDLE_TH_ERRORS
  Py_RETURN_NONE;
}

PyObject* THCPModule_turnonFree(PyObject* _unused, PyObject* noargs) {
  HANDLE_TH_ERRORS
  c10::cuda::CUDACachingAllocator::turnonFree();
  END_HANDLE_TH_ERRORS
  Py_RETURN_NONE;
}
...
static struct PyMethodDef _THCPModule_methods[] = {
    ...
    {"_cuda_shutdownFree", THCPModule_shutdownFree, METH_NOARGS, nullptr},
    {"_cuda_stopTraceMallocFree", THCPModule_stopTraceMallocFree, METH_NOARGS, nullptr},
    {"_cuda_turnonFree", THCPModule_turnonFree, METH_NOARGS, nullptr},
